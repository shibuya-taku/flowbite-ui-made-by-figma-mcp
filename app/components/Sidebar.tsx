...
export function Sidebar() {
  ...
  return (
    <aside id="logo-sidebar" className="fixed top-0 left-0 z-40 w-64 h-screen pt-20 transition-transform bg-white border-r border-gray-200" aria-label="Sidebar">
      <div className="h-full px-3 pb-4 overflow-y-auto bg-white">
        <ul className="space-y-2 font-medium">
          ...
          <li>
            <a href="#" className="flex items-center p-2 text-gray-900 rounded-lg hover:bg-gray-100 group">
              ...
              <span className="inline-flex items-center justify-center px-2 py-0.5 ml-3 text-xs font-medium text-gray-500 bg-gray-100 rounded">
                Pro
              </span>
            </a>
          </li>
          ...
          <li>
            <a href="#" className="flex items-center p-2 text-gray-900 rounded-lg hover:bg-gray-100 group">
              <svg className="flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 group-hover:text-gray-900" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 18 20">
                <path d="M17 5.923A1 1 0 0 0 16 5h-3V4a4 4 0 1 0-8 0v1H2a1 1 0 0 0-1 .923L.086 17.846A2 2 0 0 0 2.08 20h13.84a2 2 0 0 0 1.994-2.153L17 5.923ZM7 4a2 2 0 1 1 4 0v1H7V4Zm0 5a1 1 0 0 1 1-1h2a1 1 0 0 1 0 2H8a1 1 0 0 1-1-1Z"/>
              </svg>
          ...
          <li>
            ...
            <ul id="dropdown-example" className={`${isEcommerceOpen ? 'block' : 'hidden'} py-2 space-y-2`}>
              <li>
              ...
              <li>
                <a href="#" className="flex items-center w-full p-2 text-white bg-blue-600 transition duration-75 rounded-lg pl-11 group hover:bg-blue-700">Invoices</a>
              </li>
            </ul>
          </li>
          <li>
        ...
        {/* Beta section */}
        <div className="p-4 mt-6 mb-6 bg-blue-50 rounded-lg">
          <div className="flex items-center mb-2">
            <span className="bg-blue-100 text-blue-800 text-xs font-medium inline-flex items-center px-2.5 py-0.5 rounded-full mr-1">
              <svg className="w-2.5 h-2.5 mr-1.5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 20 20">
          ...
          <p className="text-sm text-blue-900 font-medium mb-2">Flowbite Pro version 1.0.0 has arrived!</p>
          <p className="text-sm text-blue-800 mb-3">Get 1 year of updates and support for 30% off!</p>
          <a href="#" className="text-sm text-blue-900 font-medium hover:underline inline-flex items-center">
            Find out more
